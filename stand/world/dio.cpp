 ...
 *
 *  dio.cpp includes a set of functions
 * that supports DIO, f0 estimation algorhythm.
 *
 */
#include "world.h"
...
// F0 calculation by using DIO (Distributed Inline filter Operation)
...
// Calculation of a nuttall window whose length is xLen
void nuttallWindow(int yLen, double *y)
{
    int i;
    double tmp;
